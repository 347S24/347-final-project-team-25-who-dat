...
In case you don't want this project to be called `whodat`:

1. Case insensitive find/replace-all from `whodat` to whatever project slug you want
2. Rename the `whodat` directory to your project slug
